...
BEGIN
  ...
  INSERT INTO financial_documents SELECT * FROM jsonb_populate_recordset(NULL::financial_documents, payload->'financial_documents');
  INSERT INTO financial_document_lines SELECT * FROM jsonb_populate_recordset(NULL::financial_document_lines, payload->'financial_document_lines');
  ...
  RETURN result;
END $$;
GRANT EXECUTE ON FUNCTION public._restore_project_0410b(jsonb) TO authenticated, service_role;
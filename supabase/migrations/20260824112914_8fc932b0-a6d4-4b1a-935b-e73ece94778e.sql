...
revoke execute on function public.fee_proposal_resolved_value(uuid) from anon;
grant execute on function public.fee_proposal_resolved_value(uuid) to authenticated, service_role;
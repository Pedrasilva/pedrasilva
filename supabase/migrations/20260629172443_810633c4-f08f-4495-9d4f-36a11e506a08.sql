...
BEGIN
  ...
  INSERT INTO public.fee_proposals (
    ...
    is_locked, locked_at, locked_project_id, notas
  ) VALUES (
    ...
    true, now(), _project_id, 'Auto-generated from project Gantt'
  )
  ...
  LOOP
    IF (v_stage_map ? r.predecessor_id::text) AND (v_stage_map ? r.successor_id::text) THEN
      ...
      VALUES (
        ...
        COALESCE(r.type::text, 'FS')::quote_dep_type,
        COALESCE(r.lag_days, 0)
      )
